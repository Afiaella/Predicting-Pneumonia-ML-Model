...
# dropout currently performing at 98%, cnn at 97+
cnn = 'model/chest_xray_cnn_100_801010.h5'
dropout_cnn = 'model-(HDF5)_file.h5'
best_model = 'model-1_(HDF5)_file.h5'
...
def index():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            test_me = pil_img.resize((224, 224,1 ))  # image is from keras, we need 150x150 for model
